...
public struct DeezerAlbum: Decodable {
    ...
    public init(id: Int, title: String, pictureId: String, artistName: String, artistId: Int, numFans: Int? = nil, releaseDate: String, tracks: [DeezerTrack]? = nil, numTracks: Int? = nil, copyright: String? = nil, label: String? = nil, artists: [DeezerArtist]? = nil, dateFavorite: Date? = nil, completeness: DeezerAlbum.CompletenessLevel) {
        self.id = id
        self.title = title
    ...
    public enum CompletenessLevel: Int, Decodable {
