...
public struct DeezerTrack: Decodable {
    ...
    internal init(title: String, id: Int, artistId: Int, artistName: String, albumId: Int, albumName: String, trackNum: Int? = nil, diskNum: Int? = nil, duration: Int, explicitContent: Bool, trackToken: String? = nil, trackTokenExpires: Int? = nil, artists: [DeezerArtist], dateFavorite: Int? = nil, picture: String? = nil) {
        self.title = title
        self.id = id
        ...
        self.trackTokenExpires = trackTokenExpires
